  ...
  return (
    <div className="lg:px-6 ">
      <div className="mx-5 font-logo flex max-md:justify-between items-baseline mb-5 md:gap-5">
        ...
        <p className="text-[0.85em] font-book-author text-book-author">{bookList.length} books</p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 px-5 lg:grid-cols-3 xl:grid-cols-4">
        {bookList.map((book) => (
